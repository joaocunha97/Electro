...
<body>
    ...
    <section id="content">
        ...
        <div class="content">
            ...
            $sql = "SELECT id, username FROM admins LIMIT $offset, $no_of_records_per_page";
            $result = mysqli_query($conn, $sql);
            if (mysqli_num_rows($result) > 0) {
                echo "<div id='container'><table class='normal'> <thead> <tr> <th>ID</th> <th>Username</th>  </tr> </thead> <tbody>";
                while ($row = mysqli_fetch_assoc($result)) {
                    echo "<tr> <td>" . $row["id"] . "</td> <td>" . $row["username"] . " </tr>";
                }
                
                echo "</tbody> </table> <br> <a style='float:right;' class='btn btn-primary' href = registar_admins.php>Criar Admin</a> </div>";  
            } else {
                echo "No Results";
            }
            ?>
