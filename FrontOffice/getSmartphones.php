...
$sql = "SELECT produtos.id, produtos.nome, produtos.preco, category.NAME, produtos.image FROM produtos INNER JOIN category on produtos.category_id=category.category_id WHERE category.NAME = 'Telemoveis';";
