...
$sql = "SELECT produtos.nome, produtos.descricao ,produtos.preco, category.NAME, produtos.image,produtos.id FROM produtos INNER JOIN category on produtos.category_id=category.category_id WHERE produtos.id=". $id .";";
